...
const About = () => {
  return (
    <section className="about-section py-16 px-6 md:px-20">
      ...
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            I’m a <span style={{fontSize: "20px"}} className="font-semibold">Frontend Developer </span>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Beyond coding, I enjoy problem-solving, learning emerging technologies, 
